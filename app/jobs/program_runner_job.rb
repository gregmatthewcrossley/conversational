class ProgramRunnerJob < ApplicationJob
  ...
  def perform(conversation_id, most_recent_point_of_interest: nil)
    ...
    @current_point_of_interest = set_current_point_of_interest(most_recent_point_of_interest)
  ...
  def set_current_point_of_interest(most_recent_point_of_interest)
    ...
    @current_point_of_interest = if most_recent_point_of_interest.nil? || @latest_location.nearby_points_of_interest.exclude?(most_recent_point_of_interest)
      ...
      @latest_location.nearby_points_of_interest.first # should be the nearest thing
